...
(function () {
  ...
  const ASSETS = [
    { name: "Sappy Seals", chain: "Ethereum", kind: "ERC-721", desc: "Sappy Seals",
      addr: "0x364c828ee171616a39897688a831c2499ad972ec", art: "seal", seed: "sappyseals", id: 7, url: "https://opensea.io/collection/sappy-seals" },
    { name: "Staked Sappy Seals", chain: "Ethereum", kind: "ERC-721", desc: "Staking wrapper — earns BITS daily.",
      addr: "0x1c70d0a86475cc707b48aa79f112857e7957274f", art: "seal", seed: "stakedseal", id: 999, url: "https://opensea.io/collection/sappy-seals" },
    ...
    { name: "Omnia Pets", chain: "Ethereum", kind: "NFT", desc: "Genesis Pixl Pets — your Omnia companion.",
      addr: "0x4e76c23fe2a4e37b5e07b5625e17098baab86c18", art: "eth", seed: "omniapets", url: "https://opensea.io/collection/omnia-pets" },
    { name: "Omnia Items", chain: "Ethereum", kind: "NFT", desc: "Gear, wearables & consumables.",
      addr: "0xf0ea56402b2e2b27556d7abf4236c7327722fe41", art: "eth", seed: "omniaitems", id: 1, url: "https://opensea.io/assets/ethereum/0xf0ea56402b2e2b27556d7abf4236c7327722fe41/1" },
    { name: "Sappy Key Coverage", chain: "Ethereum", kind: "NFT", desc: "Access keys for holder perks.",
      addr: "0x3d3ad7b00e885d3d969e03bfcbaed80fb3df6667", art: "eth", seed: "sappykey", url: "https://opensea.io/assets/ethereum/0x3d3ad7b00e885d3d969e03bfcbaed80fb3df6667/1" },
    { name: "Pixseals", chain: "Polygon", kind: "ERC-721", desc: "Gas-free pixel airdrop, 1:1 mapped.",
      addr: "0x9ae64ca2e16e6f14dad30f9e440f870a78fc323b", art: "polygon", seed: "pixseals", id: 1, url: "https://opensea.io/assets/matic/0x9ae64ca2e16e6f14dad30f9e440f870a78fc323b/1" },
  ...
  function renderAssets() {
    ...
    grid.innerHTML = ASSETS.map((a) => {
      ...
      else if (a.art === "image") ic = `<div class="ic art-image"><img src="${a.image}" alt="${a.name} preview"></div>`;
      ...
      <article class="asset">
        ...
        <a class="btn btn-ghost btn-sm" href="${a.url || `https://etherscan.io/token/${a.addr}`}" target="_blank" rel="noopener">${a.kind === "ERC-20" ? "View" : "Buy/View"} ↗</a>
